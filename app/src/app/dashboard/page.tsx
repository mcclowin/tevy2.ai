    ...
    <div className="p-8 max-w-4xl">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          { label: "Posts Drafted", value: "—", sub: "Ask Tevy to get started" },
...
function BrandTab() {
  return (
    <div className="p-8 max-w-4xl">
      ...
      <p className="text-[var(--muted)] mb-6">Generated by Tevy from your website and socials.</p>
      
      <div className="glass rounded-xl p-6 text-center">
        <div className="text-4xl mb-3">🎯</div>
        <h2 className="text-lg font-semibold mb-2">Ask Tevy to analyze your brand</h2>
        <p className="text-sm text-[var(--muted)] mb-4">
          Head to the Chat tab and ask Tevy to analyze your website and social profiles.
          The brand profile will appear here once generated.
        </p>
        <p className="text-xs text-[var(--muted)]">
          Try: "Analyze my website and create a brand profile"
        </p>
      </div>
    </div>
  );
...
function CalendarTab() {
  return (
    <div className="p-8 max-w-4xl">
      ...
      <div className="glass rounded-xl p-6 text-center">
        <div className="text-4xl mb-3">📅</div>
        <h2 className="text-lg font-semibold mb-2">Ask Tevy to show your content calendar</h2>
        <p className="text-sm text-[var(--muted)] mb-4">
          Head to the Chat tab and ask Tevy to create and show you your content calendar.
          Scheduled posts will appear here once created.
        </p>
        <p className="text-xs text-[var(--muted)]">
          Try: "Show me my content calendar"
        </p>
      </div>
    </div>
  );
...
function ResearchTab() {
  return (
    <div className="p-8 max-w-4xl">
      ...
      <p className="text-[var(--muted)] mb-6">Weekly digest — updated by Tevy every Monday</p>
      
      <div className="glass rounded-xl p-6 text-center">
        <div className="text-4xl mb-3">🔍</div>
        <h2 className="text-lg font-semibold mb-2">Ask Tevy to research your competitors</h2>
        <p className="text-sm text-[var(--muted)] mb-4">
          Head to the Chat tab and ask Tevy to research your competitors and market trends.
          Research insights will appear here once generated.
        </p>
        <p className="text-xs text-[var(--muted)]">
          Try: "Research my competitors"
        </p>
      </div>
    </div>
  );
...
/* ─── CHAT TAB ─── */
function ChatTab() {
  // TODO: Get webchatUrl from instance data stored after onboarding
  const webchatUrl = localStorage.getItem("tevy_webchat_url") || "";
  
  if (!webchatUrl) {
    return (
      <div className="p-8 max-w-4xl">
        <h1 className="text-2xl font-bold mb-1">Chat with Tevy</h1>
        <p className="text-[var(--muted)] mb-6">Webchat URL not available. Use Telegram to chat with your agent.</p>
      </div>
    );
  }
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="px-8 pt-6 pb-4 border-b border-[var(--border)]">
        <h1 className="text-2xl font-bold mb-1">Chat with Tevy</h1>
        <p className="text-[var(--muted)] text-sm">Talk to your marketing agent directly</p>
      </div>
...
function SEOTab() {
  return (
    <div className="p-8 max-w-4xl">
      ...
      <div className="glass rounded-xl p-6 text-center">
        <div className="text-4xl mb-3">🔎</div>
        <h2 className="text-lg font-semibold mb-2">Ask Tevy to run an SEO audit</h2>
        <p className="text-sm text-[var(--muted)] mb-4">
          Head to the Chat tab and ask Tevy to run an SEO audit of your website.
          Audit results and optimization recommendations will appear here once generated.
        </p>
        <p className="text-xs text-[var(--muted)]">
